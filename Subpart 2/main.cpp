...
int main(int argc, char **argv)
{
    ...
    if (fun == "fullyconnected")
    {
        ...
        Mat M = read_matrix(input_file);
        Mat W = read_matrix(weight_file);
        Mat B = read_matrix(bias_file);
    ...
    else if (fun == "pooling")
    {
        ...
        try
        {
            ...
            Mat output;
            if (type == "max")
                output = max_pooling(M, s);
            else if (type == "average")
                output = avg_pooling(M, s);
            else
            {
    ...
    else if (fun == "probability")
    {
        ...
        write_vector(output, output_file);
    }
